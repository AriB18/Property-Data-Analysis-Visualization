...
Dwelling types and ownership patterns

Family composition and income trends

Population shifts

Financial behavior (mortgages, rent, savings)
...
Source 2: PriceFinder

Time Period: 2011, 2016, and 2021
...
Python (Pandas, Matplotlib): Data analysis and trend calculations
...
Dwelling & Ownership: Rental market grew by 7.9%, and mortgage ownership declined by 12.5%.

Affordability: Median housing prices surged by 52.7%, while income growth lagged behind.

Finance: Rent-to-income ratio tripled, indicating a shift from ownership to renting.
...
Data Cleaning & Preprocessing: Structured the data using Excel and Python.

Visualization: Created combo, cluster, and stacked graphs to represent relationships between indicators.

Trend Analysis: Compared decade-long changes to derive investment and affordability insights.
...
Employment trends indicate a shift toward part-time roles and evolving family structures.

Despite steady income growth, the rising rent and mortgage burden reduce long-term investment appeal.
